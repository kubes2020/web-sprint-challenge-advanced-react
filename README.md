...
- rend the app, declare a variable with a screen.get to capture what you want, then fireEvent to change it, the assert something with expect. Arrange/Activate/Assert
